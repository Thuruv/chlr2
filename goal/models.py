...
#   *** Care for the Whole Team Since Start***
data_associates = (
...
data_process = (
    ...
    ('Historical Taxonomization Rolling Queue',
     'Historical Taxonomization Rolling Queue'),
...
class Report(models.Model):
    worker = models.CharField(
        'Whois it?', choices=data_associates, default='Select Something', max_length=25)
    date = models.DateField('Report Date', default=time.strftime("%Y-%m-%d"))
    process = models.CharField(
            'What Process?', choices=data_process, default='Select Something', max_length=50)
    ...
    details = models.CharField(
        'Any Details to Dump', blank=True, max_length=256)
